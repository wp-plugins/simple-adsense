...
== Description ==
This plugin is far from fancy. I craeted this because I could not stand the big complex adsense plugins that
...
Then can you display the contents of such box with a widet, a function call och just type `[adsense_id="1"]`
